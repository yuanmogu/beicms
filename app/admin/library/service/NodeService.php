...
class NodeService extends Service
{
    ...
    public function getMethods(bool $force = false): array
    {
        ...
        /*! 排除内置方法，禁止访问内置方法 */
        $ignores = get_class_methods('\app\AdminController');
        /*! 扫描所有代码控制器节点，更新节点缓存 */
        foreach ($this->scanDirectory($this->app->getBasePath().'admin') as $file) {
